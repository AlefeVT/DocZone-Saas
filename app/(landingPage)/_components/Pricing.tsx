...
const pricingList: PricingProps[] = [
  ...
  },
  {
    ...
    paymentLinkMonthly:
      process.env.NEXT_PUBLIC_STRIPE_MONTHLY_PLAN_INTERMEDIARY_LINK!,
    paymentLinkYearly:
      process.env.NEXT_PUBLIC_STRIPE_YEARLY_PLAN_INTERMEDIARY_LINK!,
    href: 'auth/register?payment',
  },
  {
    ...
    paymentLinkMonthly:
      process.env.NEXT_PUBLIC_STRIPE_MONTHLY_PLAN_ADVANCED_LINK!,
    paymentLinkYearly:
      process.env.NEXT_PUBLIC_STRIPE_YEARLY_PLAN_ADVANCED_LINK!,
    href: 'auth/register?payment',
  },
  {
    ...
    paymentLinkMonthly:
      process.env.NEXT_PUBLIC_STRIPE_MONTHLY_PLAN_PROFESSIONAL_LINK!,
    paymentLinkYearly:
      process.env.NEXT_PUBLIC_STRIPE_YEARLY_PLAN_PROFESSIONAL_LINK!,
    href: 'auth/register?payment',
  },
  {
                  ...
                  <div className="text-center">
                    ...
                    <div className="mt-2">
                      <PaymentLink
                        ...
                        paymentLink={pricing.paymentLinkMonthly}
                      />
                    </div>
                  </div>
                  <div className="text-center">
                    <span className="text-3xl font-bold">
                      R${pricing.priceYearly}
                    </span>
                    ...
                    <div className="mt-2">
                      <PaymentLink
                        href={pricing.href!}
                        text="Escolher Anual"
                        paymentLink={pricing.paymentLinkYearly}
                      />
                    </div>
                  </div>
                </div>
