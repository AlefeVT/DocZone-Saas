    ...
    stripe: {
      ...
      plans: {
        basic: {
          ...
          description: 'Ideal para pequenos negócios que precisam armazenar um volume moderado de documentos.',
        ...
        intermediate: {
          ...
          description: 'Perfeito para empresas de médio porte com um volume maior de documentos.',
        ...
        advanced: {
          ...
          description: 'Indicado para negócios que precisam de um armazenamento significativo para gerenciamento de documentos.',
        ...
        professional: {
          ...
          description: 'Ideal para grandes empresas ou instituições públicas com alta demanda de armazenamento.',
